    ...
    <footer className="footer-2-1">
      <div className="lg:pb-24 pb-16 mx-auto">
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 lg:gap-0 gap-y-6">
          ...
          <div className="">
            <h2 className="title-font font-semibold text-2xl mb-5">Product</h2>
            <nav className="list-none list-footer space-y-5">
              <li>
          ...
          <div className="">
            <h2 className="title-font font-semibold text-2xl mb-5">Company</h2>
            <nav className="list-none list-footer space-y-5">
              <li>
                <a href="">Contact Us</a>
              </li>
          ...
          <div className="">
            <h2 className="title-font font-semibold text-2xl mb-5">Support</h2>
            <nav className="list-none list-footer space-y-5">
              <li>
